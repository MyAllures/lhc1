<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:55:"D:\www\PHPTutorial\WWW\lhc/app/users\view\zm\index.html";i:1545823997;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                if(response!=''){
                    ...
                    for (i=0;i<response.length-1;i++){     //1-49的位置
                        ...
                        if(i!=(response.length-2)){
                            tem10='<a href="<?php echo url('jszd/look',['kithe'=>$kithe,'lx'=>0,'id'=>3]); ?>?class3='+response[i][12]+'">'+response[i][3]+'</a>';
                        }else{
                            tem10=response[i][2];
                        }
                        var tem4=0;
                        ...
                        if(response[i][9]!=0 && i!=(response.length-2)){
                            tem5='<a href="<?php echo url('jszd/look',['kithe'=>$kithe,'lx'=>1,'id'=>3]); ?>?class3='+response[i][12]+'">'+response[i][9]+'</a>';
                        }else{
