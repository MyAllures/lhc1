<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:56:"D:\www\PHPTutorial\WWW\lhc/app/users\view\zm6\index.html";i:1545824049;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div class="layui-card">
                <div class="layui-card-header">
                    ...
                    <div class="layui-btn-group" style="float:right;">
                        <a class="layui-btn layui-btn-primary layui-btn-sm" href="<?php echo url('',['ids'=>'正码1','kithe'=>$kithe]); ?>">正码1</a>
                        <a class="layui-btn layui-btn-primary layui-btn-sm" href="<?php echo url('',['ids'=>'正码2','kithe'=>$kithe]); ?>">正码2</a>
                        <a class="layui-btn layui-btn-primary layui-btn-sm" href="<?php echo url('',['ids'=>'正码3','kithe'=>$kithe]); ?>">正码3</a>
                        <a class="layui-btn layui-btn-primary layui-btn-sm" href="<?php echo url('',['ids'=>'正码4','kithe'=>$kithe]); ?>">正码4</a>
                        <a class="layui-btn layui-btn-primary layui-btn-sm" href="<?php echo url('',['ids'=>'正码5','kithe'=>$kithe]); ?>">正码5</a>
                        <a class="layui-btn layui-btn-primary layui-btn-sm" href="<?php echo url('',['ids'=>'正码6','kithe'=>$kithe]); ?>">正码6</a>
                    </div>
                </div>
