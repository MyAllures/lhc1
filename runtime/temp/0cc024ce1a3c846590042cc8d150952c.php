<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:55:"D:\www\PHPTutorial\WWW\lhc/app/users\view\bb\index.html";i:1545824153;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                if(response!=''){
                    ...
                    for (i=0;i<response.length-1;i++){     //1-49的位置
                        ...
                        if(i!=(response.length-2)){
                            num4='<a href="<?php echo url('jszd/look',['kithe'=>$kithe,'lx'=>0,'id'=>6]); ?>?class2=<?php echo $ids; ?>&class3='+response[i][12]+'">'+response[i][2]+'</a>';
                        }else{
                            num4=response[i][2];
                        }
                        num5=response[i][3];
                        ...
                        if(response[i][9]!=0 && i!=(response.length-2)){
                            num11='<a href="<?php echo url('jszd/look',['kithe'=>$kithe,'lx'=>1,'id'=>6]); ?>?class2=<?php echo $ids; ?>&class3='+response[i][12]+'">'+response[i][9]+'</a>';
                        }else{
                            num11=response[i][9];
                        }
                        num12=response[i][10];
