<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:56:"D:\www\PHPTutorial\WWW\lhc/app/users\view\wsl\index.html";i:1545824390;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div class="layui-card">
                <div class="layui-card-header">
                    ...
                    <div class="layui-btn-group" style="float:right;">
                        <a class="layui-btn layui-btn-primary layui-btn-sm" href="<?php echo url('',['ids'=>'二尾连中','kithe'=>$kithe]); ?>">二尾连中</a>
                        <a class="layui-btn layui-btn-primary layui-btn-sm" href="<?php echo url('',['ids'=>'三尾连中','kithe'=>$kithe]); ?>">三尾连中</a>
                        <a class="layui-btn layui-btn-primary layui-btn-sm" href="<?php echo url('',['ids'=>'四尾连中','kithe'=>$kithe]); ?>">四尾连中</a>
                        <a class="layui-btn layui-btn-primary layui-btn-sm" href="<?php echo url('',['ids'=>'二尾连不中','kithe'=>$kithe]); ?>">二尾连不中</a>
                        <a class="layui-btn layui-btn-primary layui-btn-sm" href="<?php echo url('',['ids'=>'三尾连不中','kithe'=>$kithe]); ?>">三尾连不中</a>
                        <a class="layui-btn layui-btn-primary layui-btn-sm" href="<?php echo url('',['ids'=>'四尾连不中','kithe'=>$kithe]); ?>">四尾连不中</a>
                ...
                if(response!=''){
                    ...
                    for (i=0;i<response.length-1;i++){     //1-49的位置
                        ...
                        if(i!=(response.length-2)){
                            num4='<a href="<?php echo url('jszd/look',['kithe'=>$kithe,'lx'=>0,'id'=>14]); ?>?class2=<?php echo $ids; ?>&class3='+response[i][12]+'">'+response[i][2]+'</a>';
                        }else{
                            num4=response[i][2];
                        }
                        num5=response[i][3];
                        ...
                        if(response[i][9]!=0 && i!=(response.length-2)){
                            num11='<a href="<?php echo url('jszd/look',['kithe'=>$kithe,'lx'=>1,'id'=>14]); ?>?class2=<?php echo $ids; ?>&class3='+response[i][12]+'">'+response[i][9]+'</a>';
                        }else{
                            num11=response[i][9];
                        }
                        num12=response[i][10];
