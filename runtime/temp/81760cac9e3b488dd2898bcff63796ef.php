<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:59:"D:\www\PHPTutorial\WWW\lhc/app/users\view\zhudan\index.html";i:1545200588;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <form action="<?php echo url('cha'); ?>" method="post" id="form1" class="layui-form">
                <div class="layui-card">
                    <div class="layui-card-header">
                        <span style="color: red;"><?php echo $data['kauser']; ?></span>股东注单查询&nbsp;[<?php echo $kithe; ?>期]
                    ...
                    <div class="layui-card-body" pad15>
                        <table class="layui-table">
                            ...
                            <tr>
                                ...
                                <td><a href="<?php echo url('index2',['username'=>$r['zong']]); ?>"><?php echo $r['rs5']['sum_m']; ?></a></td>
