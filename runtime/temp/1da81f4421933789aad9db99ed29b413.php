<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:60:"D:\www\PHPTutorial\WWW\lhc/app/users\view\zhudan\index2.html";i:1545826918;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <form action="<?php echo url('cha'); ?>" method="post" id="form1" class="layui-form">
                <div class="layui-card">
                    <div class="layui-card-header">
                        <span style="color: red;"><?php echo $username; ?></span>总代理注单查询&nbsp;[<?php echo $kithe; ?>期]
                    ...
                    <div class="layui-card-body" pad15>
                        <table class="layui-table">
                            ...
                            <tr>
                                ...
                                <td><?php echo $r['dai']; ?>(<span style="color:#ff6600;"><?php echo $r['guan']['xm']; ?></span>)</td>
                                <td><?php echo $r['rs5']['re']; ?></td>
                                <td><a href="<?php echo url('index3',['username'=>$r['dai']]); ?>"><?php echo $r['rs5']['sum_m']; ?></a></td>
