<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:59:"D:\www\PHPTutorial\WWW\lhc/app/users\view\zong\addzong.html";i:1545375216;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                ...
                <div class="layui-card-body" pad15>
                    <form class="layui-form" action="<?php echo url('savezong',['act'=>'add']); ?>" method="post" id="form">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <select name="sj">
                                    <?php if($iend > 0): $__FOR_START_30445__=$istart;$__FOR_END_30445__=$iend;for($i=$__FOR_START_30445__;$i < $__FOR_END_30445__;$i+=10){ if($i == 0): ?>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <select name="sf">
                                    <?php if($iend > 0): $__FOR_START_3525__=$istart;$__FOR_END_3525__=$iend;for($i=$__FOR_START_3525__;$i < $__FOR_END_3525__;$i+=10){ if($i == 0): ?>
                                    <option value="0">不占成</option>
                                    <?php else: ?>
                                    <option value="<?php echo $i; ?>"><?php echo $i; ?>%</option>
                                    <?php endif; } else: ?>
