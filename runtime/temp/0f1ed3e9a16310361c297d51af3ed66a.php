<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:54:"D:\www\PHPTutorial\WWW\lhc/app/users\view\guan\zi.html";i:1545045260;}*/ ?>
<html>
<head>
    <meta charset="utf-8">
    <title>修改资料</title>
                ...
                <div class="layui-card-body">
                    <form class="layui-form" id="form1" method="post" enctype="multipart/form-data">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-form-mid layui-word-aux"><?php echo $zi['kauser']; ?></div>
                        </div>
                        ...
                        <div class="layui-form-item">
                            <div class="layui-input-block">
                                <input type="hidden" value="<?php echo $zi['id']; ?>" name="id" />
